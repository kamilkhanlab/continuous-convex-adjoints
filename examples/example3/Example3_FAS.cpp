...
#define T1    RCONST(2.0)   /* first output time */
...
int main()
{
    ...
    for (realtype i = 10.78; i <= 10.78 ; i += 0.1) {
...
static void Getresults(N_Vector u)
{
    ...
    ofstream outfile11;
    outfile11.open("/Users/yulanzhang/Desktop/Adjoint-paper/Example-updated/Example3/matlab_plots/x.txt", ios::app);
    outfile11 << xi_hist << "\n";
    outfile11.close();

    ofstream outfile21;
    outfile21.open("/Users/yulanzhang/Desktop/Adjoint-paper/Example-updated/Example3/matlab_plots/x_lb.txt", ios::app);
    outfile21 << lb_hist << "\n";
    outfile21.close();


    ofstream outfile31;
    outfile31.open("/Users/yulanzhang/Desktop/Adjoint-paper/Example-updated/Example3/matlab_plots/x_ub.txt", ios::app);
    outfile31 << ub_hist << "\n";
    outfile31.close();


    ofstream outfile41;
    outfile41.open("/Users/yulanzhang/Desktop/Adjoint-paper/Example-updated/Example3/matlab_plots/x_cv.txt", ios::app);
    outfile41 << cv_hist << "\n";
    outfile41.close();

    ofstream outfile52;
    outfile52.open("/Users/yulanzhang/Desktop/Adjoint-paper/Example-updated/Example3/matlab_plots/x_cc.txt", ios::app);
    outfile52 << cc_hist << "\n";
    outfile52.close();
}
