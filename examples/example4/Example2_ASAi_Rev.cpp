...
double pL[NP] = { -2};      /* lower bound of parameters */
double pU[NP] = { 2 };      /* upper bound of parameters */
double fixedp[NP] = {-1};     /* fixed value of parameters*/
...
static void PrintOutput(realtype tfinal, N_Vector x_Re, N_Vector xB, N_Vector qB)
{
    ...
    printf("x(t0):      %12.4e %12.4e \n",
        Ith(x_Re, 1), Ith(x_Re, 2));
    printf("--------------------------------------------------------\n");
    printf("Sensitivity       p1\n\n");
    printf("dg/dp:      %12.4e \n" ,
        -Ith(qB, 1));
    printf("--------------------------------------------------------\n\n");
    printf("--------------------------------------------------------\n\n");
